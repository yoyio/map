<template>
  <div class="about">
    <div class="img"></div>
    <div class="aboutO">
      <p class="aboutOTitle" style="font-size: 24px; text-align: center">
        亞洲大學-精準健康研究中心
      </p>
      <p style="padding: 15px 0px">
        本中心以精準營養健康為主要產業發展核心，透過智慧健康產業技術研發與人才培育及軟體
